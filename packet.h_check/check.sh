...
git --git-dir=/srv/git/repositories/batman-adv.git/ cat-file -p master:packet.h > batman-adv_master.packet.h
git --git-dir=/srv/git/repositories/batman-adv.git/ cat-file -p next:packet.h > batman-adv_next.packet.h
git --git-dir=/srv/git/repositories/batman-adv.git/ cat-file -p maint:packet.h > batman-adv_maint.packet.h

git --git-dir=/srv/git/repositories/batctl.git/ cat-file -p master:packet.h > batctl_master.packet.h
git --git-dir=/srv/git/repositories/batctl.git/ cat-file -p next:packet.h > batctl_next.packet.h
git --git-dir=/srv/git/repositories/batctl.git/ cat-file -p maint:packet.h > batctl_maint.packet.h
